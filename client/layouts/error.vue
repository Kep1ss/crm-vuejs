    ...
    <section class="section">
      <div class="container mt-5">
        <div class="page-error">
          <div class="page-inner" v-if="error.statusCode == 404">
            <img src="/img/404.svg" style="width: 400px; object-fit: cover" />
          ...
          <div class="page-inner" v-else-if="error.statusCode == 500">
            <img src="/img/500.svg" style="width: 400px; object-fit: cover" />
            <div class="page-description text-danger mt-3" v-if="isDebug()">
              {{ error.message }}
            </div>
            <div class="page-description mt-3" v-else>Terjadi Kesalahan</div>
            <div class="page-search">
